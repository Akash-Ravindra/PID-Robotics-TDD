 ...
 * @brief Tests to validate the functionality of the Robot PID class. Test indicate specs desired
 * @version 0.1
 * @date 2022-09-30
 * 
...
TEST(PidControllerTest, test_getParams) {
  ...
  EXPECT_EQ(control.getControllerParams(), (std::tuple<double, double, double>(0.0,0.0,0.0)));
}
